...
function generateFirstPurchaseEmail(options = {}) {
  const { customerName = "Valued Customer", appBaseUrl = "https://Shopora-omega.vercel.app" } = options;

  const subject = "Thank You for Choosing Shopora";
  const previewText = "Your first Shopora order is confirmed. Explore plans, workout tracking, nearby fitness centers, and more.";
...
<body>
  <div class="email-container">
    <!-- Header -->
    <div class="header">
      <img src="${appBaseUrl}/logo.png" alt="Shopora" class="logo" style="display: inline-block;">
      <h1>Shopora</h1>
    </div>
    ...
    <div class="content">
      ...
      <p class="message">
        Thank you for choosing <strong>Shopora</strong> for your fitness journey! We're thrilled that you've made your first purchase with us. This is just the beginning of a transformative experience.
      </p>

      <p class="message">
        Shopora is more than just a shopping platform—it's your comprehensive fitness companion designed to help you achieve your health and wellness goals.
      </p>

      <!-- Features Section -->
      <h2 class="features-heading">What You Get With Shopora ✨</h2>
      ...
      <div class="signoff-section">
        ...
        <p class="message">
          Happy training!<br>
          <strong>The Shopora Team</strong>
        </p>
      </div>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
      <p class="footer-text">Shopora © 2026. All rights reserved.</p>
...
Thank you for choosing Shopora for your fitness journey! We're thrilled that you've made your first purchase with us. This is just the beginning of a transformative experience.

Shopora is more than just a shopping platform—it's your comprehensive fitness companion designed to help you achieve your health and wellness goals.

WHAT YOU GET WITH Shopora
...
function generateInactivityReminderEmail(options = {}) {
  const { customerName = "Friend", daysInactive = 30, appBaseUrl = "https://Shopora.com" } = options;

  const subject = "✨ We've Missed You at Shopora! ✨";
  ...
  <div class="email-container">
    ...
    <div class="footer">
      ...
      <p class="footer-text" style="margin-top: 16px; font-size: 11px;">
        Shopora, 123 Fitness Street, Wellness City, 560001
      </p>
    </div>
  </div>
</body>
