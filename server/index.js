...
app.use("/api/membership/create-order", paymentLimiter);
app.use("/api/membership/verify-payment", paymentLimiter);
app.use(
  "/api/auth",
  authLimiter,
  require("./routes/auth"),
...
// Shopora Rewards loyalty points routes
...
// ── Health check ─────────────────────────────────────────────────────────────
app.get("/", (req, res) => res.send("Shopora API running"));
