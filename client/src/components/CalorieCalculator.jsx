  ...
  return (
    ...
    >
      ...
      <div className="mb-8 sm:mb-16">
        ...
        <h1 className="font-heading text-2xl md:text-3xl text-slate-950 dark:text-white
      ...
      <div className="grid lg:grid-cols-12 gap-6 sm:gap-10">
        ...
        >
          <form onSubmit={handleCalculate} className="space-y-6 sm:space-y-8">
                ...
                {["male", "female"].map((g) => (
                  <button
                    ...
                    className={`flex-1 py-3 px-4 sm:px-8 rounded-full text-xs tracking-widest
                        ...
                        : "bg-transparent border-stone-200 text-stone-500 hover:border-indigo-400"
                      }`}
                  >
                    {g}
                  </button>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-stone-200 bg-white rounded-lg px-4 py-3
                             ...
                             focus:border-indigo-500 transition-colors min-h-11 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
              ...
              <div>
                ...
                <select
                  className="w-full border border-stone-200 bg-white rounded-lg px-4 py-3
                             ...
                             transition-colors appearance-none min-h-11 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 text-white text-sm tracking-widest uppercase
                         py-4 rounded-full hover:bg-indigo-700 transition-colors shadow-sm
          ...
          >
            {result ? (
              <div className="space-y-6 sm:space-y-8">
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-3 flex-wrap">
                    <span className="font-heading text-5xl sm:text-6xl leading-none text-indigo-100">
                      {result.maintenance}
                    </span>
              ...
              >
                ...
                <h3
                  className="font-heading text-xl sm:text-2xl text-stone-900
                             mb-3 tracking-tight"
                >
                  Ready to Calculate.
                </h3>
