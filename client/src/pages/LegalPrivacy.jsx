      ...
      <section className="bg-white border-b border-stone-200">
        <div className="max-w-5xl mx-auto px-5 lg:px-10 py-16 sm:py-20 md:py-24">
          <div className="fade-up">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl text-stone-900 leading-[1.15] mb-4 sm:mb-6">
              Privacy Policy
            </h1>
            <p className="text-base sm:text-lg text-stone-600 leading-relaxed max-w-2xl">
              We take your privacy seriously. This policy explains how Shopora collects, uses, and protects your personal information.
            </p>
          </div>
        ...
        <div className="space-y-10 sm:space-y-14">
          ...
          <section id="section-1" className="fade-up delay-3 scroll-mt-20">
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              <h2 className="font-heading text-2xl sm:text-3xl text-stone-900 mb-4">
                1. Information We Collect
              </h2>
              <p className="text-sm sm:text-base text-stone-600 leading-relaxed mb-5">
                Shopora collects information to provide better services to our customers through various methods:
              </p>
          ...
          <section id="section-2" className="fade-up scroll-mt-20">
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <ul className="space-y-3 text-sm sm:text-base text-stone-600">
                <li className="flex gap-3">
                  <span className="text-stone-400 flex-shrink-0 font-bold">OK</span>
          ...
          <section id="section-3" className="fade-up scroll-mt-20">
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <p className="text-sm sm:text-base text-stone-600 leading-relaxed mb-5">
                Shopora does not sell your personal information. We may share your information in the following circumstances:
              </p>
          ...
          <section id="section-4" className="fade-up scroll-mt-20">
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <p className="text-sm sm:text-base text-stone-600 leading-relaxed mb-5">
                Shopora implements reasonable administrative, technical, and physical safeguards to protect your personal information against unauthorized access and alteration.
              </p>
            ...
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="border border-stone-200 rounded-lg p-4 flex items-start gap-3">
                  <span className="text-stone-900 font-bold text-lg flex-shrink-0">OK</span>
            ...
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <div className="bg-white border border-stone-200 rounded-lg p-6 space-y-4">
                <div>
                  ...
                  <p className="text-base text-stone-900 font-medium">privacy@Shopora.com</p>
                </div>
                <div>
                  <p className="text-xs text-stone-400 uppercase tracking-wider font-semibold mb-2">Phone</p>
                  <p className="text-base text-stone-900 font-medium">1-800-Shopora (Option 3)</p>
                </div>
                <div>
        ...
        <div className="mt-16 sm:mt-20 pt-8 sm:pt-12 border-t border-stone-200 fade-up">
          <div className="bg-stone-100 rounded-xl p-6 sm:p-8 text-center">
            <p className="text-sm text-stone-700 leading-relaxed max-w-2xl mx-auto">
              Your privacy is important to us. Shopora is committed to protecting and respecting your personal information while providing you with an excellent service experience.
            </p>
          </div>
        </div>
      ...
      <footer className="border-t border-stone-200 bg-white mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-10 py-8 sm:py-10">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <span className="font-heading text-lg text-stone-900">Shopora</span>
            <CreatorCredit />
                      <p className="text-xs text-stone-400">© 2026 Shopora. Fitness commerce & tools.</p>
          </div>
        </div>
      </footer>
    </div>
