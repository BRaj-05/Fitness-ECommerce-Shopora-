  ...
  const downloadInvoice = async (order) => {
    try {
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:20px">
        ...
        <div><h4 style="font-size:10px;color:#78716c;text-transform:uppercase">Sold By</h4><div style="margin-top:6px">Shopora India Pvt. Ltd.</div><div>India</div></div>
      </div>
        ...
        <div className="bg-white border border-stone-200 rounded-2xl overflow-hidden
          ...
          <div className="px-4 md:px-7 py-4 md:py-5 border-b border-stone-100
            ...
            <div>
              ...
              <h2 style={{ fontFamily: "Manrope, Inter, sans-serif" }}
                  ...
                  <>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <span style={{ fontFamily: "Manrope, Inter, sans-serif" }}
