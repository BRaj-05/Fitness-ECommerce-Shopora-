        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-10 py-16 sm:py-20 md:py-24">
          <div className="fade-up">
            ...
            <p className="text-base sm:text-lg text-stone-600 leading-relaxed max-w-2xl">
              Please review these terms carefully. By accessing Shopora, you agree to be bound by these conditions and our policies.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
          ...
          <section id="section-1" className="fade-up delay-3">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              <h3 className="font-heading text-lg sm:text-xl text-stone-900 mb-2">
                1. Acceptance of Terms
              </h3>
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                By using Shopora, you agree to these Terms. We reserve the right to update them anytime.
              </p>
            </div>
          </section>
          ...
          <section id="section-7" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                All content is Shopora property. Reproduction or commercial use without permission is prohibited.
              </p>
            </div>
          </section>
          ...
          <section id="section-8" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                Shopora is not liable for indirect, consequential, or punitive damages from using our Platform.
              </p>
            </div>
          </section>
          ...
          <section id="section-10" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                <span className="block mb-1">legal@Shopora.com</span>
                <span className="block">1-800-Shopora</span>
              </p>
            </div>
          </section>
        ...
        <div className="mt-16 sm:mt-20 pt-8 sm:pt-12 border-t border-stone-200 fade-up">
          <div className="bg-stone-100 rounded-xl p-6 sm:p-8 text-center">
            <p className="text-sm text-stone-700 leading-relaxed max-w-2xl mx-auto">
              By using Shopora, you acknowledge that you have read, understood, and agree to be bound by these Terms & Conditions. If you disagree with any part, please discontinue use of the Platform.
            </p>
          </div>
        </div>
