          ...
          <BrowserRouter>
            <PageTransition>
              <Routes>
                ...
                <Route path="/shop" element={<NonAdminRoute><ShopPage /></NonAdminRoute>} />
                ...
                <Route path="/invoice/payment/:orderId" element={<PaymentInvoice />} />
                ...
                <Route path="/admin/bugs" element={<AdminRoute><AdminBugs /></AdminRoute>} />
                <Route path="/admin/customers" element={<AdminRoute><AdminCustomers /></AdminRoute>} />
                <Route path="/admin/customers/:userId" element={<AdminRoute><AdminCustomerDetail /></AdminRoute>} />
