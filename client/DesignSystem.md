...
```markdown
# Shopora — Design System Reference

Use this file as context whenever designing or building any UI component, page, or screen for Shopora.
...
**Shopora uses [Framer Motion](https://www.framer.com/motion/) as the primary animation library** for all interactive animations, page transitions, and micro-interactions. CSS animations are used only for simple, passive entrance animations.
...
4. **Use `will-change` only for continuous animations** (rare in Shopora)
