...
This document explains how to configure and use the local development admin authentication added to Shopora. It is intentionally separate from production authentication (Google / Firebase) so contributors can test admin features locally without production credentials.
